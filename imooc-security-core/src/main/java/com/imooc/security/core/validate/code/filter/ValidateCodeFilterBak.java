...
//                && StringUtils.endsWithIgnoreCase(request.getMethod(),"post")
    ...
    private void validate(ServletWebRequest request) {
        ...
        ImageCode codeInSession = (ImageCode) sessionStrategy.getAttribute(request, ValidateCodeProcessor.SESSION_KEY_PREFIX+ ValidateCodeType.IMAGE);
        ...
        if (codeInSession.isExpried()) {
            sessionStrategy.removeAttribute(request, ValidateCodeProcessor.SESSION_KEY_PREFIX+ ValidateCodeType.IMAGE);
